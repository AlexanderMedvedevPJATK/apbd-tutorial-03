    ...
    public class ContainerFactory
    {
        ...
        public static Container? CreateContainer()
        {
            ...
            switch (input)
            {
                case 1:
                    bool hazardous;
                    do Console.Write("Is the cargo hazardous? (true/false): ");
                    while (!bool.TryParse(Console.ReadLine(), out hazardous));

                    var liquidContainer =
                        new LiquidContainer(cargoMass, height, tareWeight, depth, maxPayload, hazardous);
                    Containers.Add(liquidContainer);
                    return liquidContainer;
                case 2:
                    double pressure;
                    do Console.Write("Enter pressure in atmospheres: ");
                ...
                case 3:
                    ...
                    int productIndex;
                    do Console.Write("Enter product index from the list: ");
                    ...
                    double temperature;
                    do Console.Write("Enter temperature in Celsius: ");
                    while (!double.TryParse(Console.ReadLine(), out temperature));

                    var refrigeratedContainer = new RefrigeratedContainer(cargoMass, height, tareWeight, depth,
                        maxPayload, product, temperature);
        ...
        public static void LoadContainer()
        {
            ...
            var container = GetSingleContainer();
        ...
        public static List<Container> GetManyContainer()
        {
            ...
            Console.Write("Enter container indexes from the list separated by space: ");
        ...
        {
            Containers.Remove(GetSingleContainer());
        }
        
        public static void UnloadContainer()
        {
            GetSingleContainer().Unload();
        }
    }
}